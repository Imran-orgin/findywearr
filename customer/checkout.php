...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['place_order'])) {
    ...
    if (empty($delivery_address)) {
        ...
        if (mysqli_stmt_execute($order_stmt)) {
            ...
            // Add notification to shop owner
            ...
            $notif_msg  = "New order #" . $order_id . " received from " . $_SESSION['name'];
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-7">
            ...
            <div class="fw-card">
                ...
                <div class="row g-3">
                    <div class="col-6">
                        <div class="role-card" id="codCard" onclick="selectPayment('cod')">
                    ...
                    <div class="col-6">
                        <div class="role-card" id="onlineCard" onclick="selectPayment('online')">
                            <i class="fas fa-credit-card"></i>
                            <h6>Online Payment</h6>
                            <small class="text-muted">Pay now securely</small>
                        </div>
                    </div>
                </div>
